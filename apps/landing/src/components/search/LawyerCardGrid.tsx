...
const CONSULT_ICON: Record<ConsultTypeUI, React.ElementType> = {
  video:       Video,
  phone:       Phone,
  'in-person': Building2,
};

const CONSULT_LABEL_KEY: Record<ConsultTypeUI, string> = {
  video:       'video',
  phone:       'phone',
  'in-person': 'inPerson',
};
  ...
  return (
    ...
    >
      <Link
        ...
        aria-label={`View ${lawyer.name}'s profile — ${lawyer.primarySpecialization}`}
      >
        {/* ── Visual header ───────────────────────────────── */}
